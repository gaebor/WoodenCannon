...
namespace wc{
    //! defines the (only) member of ComplexParent
    template<>
    struct MyMembers<ComplexParent> : public MembersHelper<ComplexParent>
    {
        typedef Members<ComplexParent, M<offsetof(ComplexParent, v), std::vector<int>>::value> List;
    };

    //! defines the (only) member of ComplexChild
    template<>
    struct MyMembers<ComplexChild> : public MembersHelper<ComplexChild>
    {
        typedef Members<ComplexChild, M<offsetof(ComplexChild, vv), std::vector<int>>::value> List;
    };
